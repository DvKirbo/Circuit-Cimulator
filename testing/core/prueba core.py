...
simulador.crear_nodo("C1", capacitancia=0.001)
simulador.crear_nodo("C2", capacitancia=0.002)
simulador.crear_nodo("C3", capacitancia=0.003)
simulador.conectar_nodos("C1", "C2")
simulador.conectar_nodos("C2", "C3")

nodo_c3 = simulador.nodos["C3"]
capacitancia_total = simulador.calcular_capacitancia_total(nodo_c3)
print(f"Capacitancia total: {capacitancia_total} F")